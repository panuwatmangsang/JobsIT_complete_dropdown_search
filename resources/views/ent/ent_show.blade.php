                ...
                <div class="card-body">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="jobs_name_company" placeholder="กรุณากรอกชื่อบริษัท" value="{{$jobs_post->jobs_name_company}}">
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-8">
                                <label for="rank">ตำแหน่งงานที่ต้องการ</label>
                                <input type="text" class="form-control" name="jobs_name" placeholder="กรุณากรอกตำแหน่งงาน" value="{{$jobs_post->jobs_name}}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="quantity">จำนวนที่ต้องการ</label>
                                <input type="text" class="form-control" name="jobs_quantity" placeholder="จำนวนที่ต้องการ" value="{{$jobs_post->jobs_quantity}}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="quantity">จำนวนเงินเดือน</label>
                                <input type="text" class="form-control" name="jobs_salary" placeholder="เงินเดือน" value="{{$jobs_post->jobs_salary}}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlSelect1">ประเภทของงาน</label>
                            <select class="form-control" name="jobs_type" value="{{$jobs_post->jobs_type}}" id="exampleFormControlSelect1">
                                <option value="fulltime" {{ $jobs_post->jobs_type == "fulltime" ? 'selected' : '' }}>Fulltime</option>
                                <option value="pasttime" {{ $jobs_post->jobs_type == "pasttime" ? 'selected' : '' }}>Pasttime</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlSelect1">ประเภทการทำงาน</label>
                            <select class="form-control" name="location_work" value="{{$jobs_post->location_work}}" id="exampleFormControlSelect1">
                                <option value="wfh" {{ $jobs_post->location_work == "wfh" ? 'selected' : '' }}>Work From Home</option>
                                <option value="company" {{ $jobs_post->location_work == "company" ? 'selected' : '' }}>At Company</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="datepicker" name="start_post" value="{{$jobs_post->start_post}}" width="276" />
                            </div>

                            <div class="form-group col-md-6">
                                <label for="exampleFormControlTextarea1">วันที่สิ้นสุดประกาศ :</label>
                                <input class="form-control" id="datepicker" name="stop_post" value="{{$jobs_post->start_post}}" width="276" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">ข้อความในการโพสต์</label>
                            <textarea class="form-control" name="jobs_detail" id="exampleFormControlTextarea1" rows="8">{{$jobs_post->jobs_detail}}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="nameCompany">ข้อมูลการติดต่อ</label>
                            <textarea class="form-control" name="jobs_contact" id="exampleFormControlTextarea1" rows="8">{{$jobs_post->jobs_contact}}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">ที่อยู่ของบริษัท</label>
                            <textarea class="form-control" name="jobs_address" id="exampleFormControlTextarea1" rows="8">{{$jobs_post->jobs_address}}</textarea>
